...
import { resolveEvalLessonId } from '@/services/progressService'
...
function useEvaluationHref(): string {
  ...
  return `/leccion/${lessonId}/evaluacion`
}
...
export function Sidebar() {
  ...
  const evalHref = useEvaluationHref()
